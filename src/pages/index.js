...
const HomePage = () => {
  return (
      <Layout>
        ...
        While I am working on my portfolio you can check out some of my <a href="https://glitch.com/@mehtapaydin" target="_blank">glitches </a> and <a href="https://vsco.co/uzgunumleyla" target="_blank">photographs</a>here.
        </p>
       </div>
      </Layout>
    )
